...
/**
 * Created by sonminhee on 2017. 11. 9..
 */
...
public class BluetoothSerialClient {
     ...
     *
     * @param context
     * @param device                    블루투스 디바이스. {@link_getPairedDevices} 또는 {@link_scanDevices} 를 통하여 가져온 블루투스 디바이스 인스턴스.
     * @param bluetoothStreamingHandler 블루투스 스트리밍 핸들러.
     * @return 만약 블루투스를 사용할 수 없는 상태라면 false. {@link_enableBluetooth} 를 통하여 블루투스를 사용 가능한 상태로 만들어줘야 한다.
     */
